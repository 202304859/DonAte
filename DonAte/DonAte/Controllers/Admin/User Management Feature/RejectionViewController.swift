...
class RejectionViewController: UIViewController {
    ...
    private func showRejectionConfirmation() {
        let alert = UIAlertController(
            ...
            message: "Are you sure you want to reject BahrainiYouthKitchen application?",
    ...
    private func showSuccessAlert() {
        let alert = UIAlertController(
            title: "Success!",
            message: "The rejection form has been sent to BahrainiYouthKitchen",
            preferredStyle: .alert
        )
...
extension Notification.Name {
    static let applicationRejected = Notification.Name("applicationRejected")
}
